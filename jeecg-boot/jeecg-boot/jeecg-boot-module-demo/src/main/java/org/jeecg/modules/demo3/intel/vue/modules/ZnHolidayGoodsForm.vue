        ...
        <a-row>
          <a-col :span="24">
            <a-form-item label="业务区" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['ywqid']" placeholder="请输入业务区"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="更新日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择更新日期" v-decorator="['sdate']" :trigger-change="true" style="width: 100%"/>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'ywqid','holidayid','xlid','goodsid','goodsname','sdate'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'ywqid','holidayid','xlid','goodsid','goodsname','sdate'))
      },
    }
  }
</script>