  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'shopid','xlid','goodsid','classtype','normalprice','minstock','minorder','closeqty','qty','flag','sdate','seasontype','seasonBegindate','holidaytype','holidayBegindate','holidayEnddate'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'shopid','xlid','goodsid','classtype','normalprice','minstock','minorder','closeqty','qty','flag','sdate','seasontype','seasonBegindate','holidaytype','holidayBegindate','holidayEnddate'))
      },
    }
  }
</script>