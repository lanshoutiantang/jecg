        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="商品类别" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['classtype']" placeholder="请输入商品类别"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="季节开始日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['seasonBegindate']" placeholder="请输入季节开始日期"></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/intel/znGoodsHis/add",
          edit: "/intel/znGoodsHis/edit",
          queryById: "/intel/znGoodsHis/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'createBy','createTime','updateBy','updateTime','sysOrgCode','shopid','xlid','goodsid','classtype','normalprice','minstock','minorder','closeqty','qty','flag','sdate','seasonBegindate','holidayBegindate','seasontype','holidaytype','holidayEnddate'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'createBy','createTime','updateBy','updateTime','sysOrgCode','shopid','xlid','goodsid','classtype','normalprice','minstock','minorder','closeqty','qty','flag','sdate','seasonBegindate','holidayBegindate','seasontype','holidaytype','holidayEnddate'))
      },
    }
  }
</script>