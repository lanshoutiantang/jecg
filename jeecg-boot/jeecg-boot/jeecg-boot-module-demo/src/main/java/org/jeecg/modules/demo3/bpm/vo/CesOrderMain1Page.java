 ...
 */
@Data
@ApiModel(value="ces_order_main1Page对象", description="商品订单表")
public class CesOrderMain1Page {
	...
	private List<CesOrderGoods1> cesOrderGoods1List;
	@ExcelCollection(name="订单客户")
	@ApiModelProperty(value = "订单客户")
	private List<CesOrderCustomer1> cesOrderCustomer1List;
