  ...
  <a-spin :spinning="confirmLoading">
    ...
    <a-tabs v-model="activeKey" @change="handleChangeTabs">
      <a-tab-pane tab="促销商品表" :key="refKeys[0]" :forceRender="true">
        <j-editable-table
          :ref="refKeys[0]"
          :loading="spZnPromGoodsTable.loading"
          :columns="spZnPromGoodsTable.columns"
          :dataSource="spZnPromGoodsTable.dataSource"
          :maxHeight="300"
  ...
  export default {
    ...
    data() {
      return {
        ...
        refKeys: ['spZnPromGoods', ],
        tableKeys:['spZnPromGoods', ],
        activeKey: 'spZnPromGoods',
        // 促销商品表
        spZnPromGoodsTable: {
          loading: false,
          dataSource: [],
        ...
        url: {
          add: "/oooo/spZnPromPlan/add",
          edit: "/oooo/spZnPromPlan/edit",
          queryById: "/oooo/spZnPromPlan/queryById",
          spZnPromGoods: {
            list: '/oooo/spZnPromPlan/querySpZnPromGoodsByMainId'
          },
        }
      }
    },
    ...
    methods: {
      addBefore(){
        ...
        this.spZnPromGoodsTable.dataSource=[]
      },
      getAllTable() {
      ...
      editAfter() {
        ...
        if (this.model.id) {
          ...
          this.requestSubTableData(this.url.spZnPromGoods.list, params, this.spZnPromGoodsTable)
        }
      },
      /** 整理成formData */
      classifyIntoFormData(allValues) {
        ...
        return {
          ...main, // 展开
          spZnPromGoodsList: allValues.tablesValue[0].values,
        }
      },
      //渲染流程表单数据
      showFlowData(){
