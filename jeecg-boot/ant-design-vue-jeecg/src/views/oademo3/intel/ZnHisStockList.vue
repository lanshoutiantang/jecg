<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" v-has="'others:download'" icon="download" @click="handleExportXls('商品历史库存表')">导出</a-button>
    ...
    <zn-his-stock-modal ref="modalForm" @ok="modalFormOk"></zn-his-stock-modal>
  </a-card>
</template>
...
<script>
  ...
  import ZnHisStockModal from './modules/ZnHisStockModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/intel/znHisStock/list",
          delete: "/intel/znHisStock/delete",
          deleteBatch: "/intel/znHisStock/deleteBatch",
          exportXlsUrl: "/intel/znHisStock/exportXls",
          importExcelUrl: "intel/znHisStock/importExcel",
