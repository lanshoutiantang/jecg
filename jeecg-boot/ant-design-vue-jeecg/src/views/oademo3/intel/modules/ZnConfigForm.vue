    ...
    <j-form-container :disabled="formDisabled">
      <a-form :form="form" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="最小起订量可销天数" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input-number v-decorator="['dmsMinorder']" placeholder="请输入最小起订量可销天数" style="width: 100%"/>
            </a-form-item>
          </a-col>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/intel/znConfig/add",
          edit: "/intel/znConfig/edit",
          queryById: "/intel/znConfig/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'shopid','classtype','orderdate','weekflag','safedays','arrivaldays','dmsMinorder'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'shopid','classtype','orderdate','weekflag','safedays','arrivaldays','dmsMinorder'))
      },
    }
  }
</script>