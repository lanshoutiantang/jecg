<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" v-has="'others:download'" icon="download" @click="handleExportXls('小类折扣与销量')">导出</a-button>
    ...
    <zn-xl-dms-modal ref="modalForm" @ok="modalFormOk"></zn-xl-dms-modal>
  </a-card>
</template>
...
<script>
  ...
  import ZnXlDmsModal from './modules/ZnXlDmsModal'
    ...
    data () {
      return {
        ...
        columns: [
          ...
          {
            title:'小类在disc1—disc2 折扣范围内的单品的日均销量',
            align:"center",
            dataIndex: 'dmsDisc'
          },
          {
            title:'小类在原价销售时单品的日均销量',
            align:"center",
            dataIndex: 'dmsOri'
          },
          {
        ...
        url: {
          list: "/intel/znXlDms/list",
          delete: "/intel/znXlDms/delete",
          deleteBatch: "/intel/znXlDms/deleteBatch",
          exportXlsUrl: "/intel/znXlDms/exportXls",
          importExcelUrl: "intel/znXlDms/importExcel",
