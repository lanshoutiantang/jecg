<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" v-has="'others:download'" icon="download" @click="handleExportXls('商品日销量表')">导出</a-button>
    ...
    <zn-dayly-sales-modal ref="modalForm" @ok="modalFormOk"></zn-dayly-sales-modal>
  </a-card>
</template>
...
<script>
  ...
  import ZnDaylySalesModal from './modules/ZnDaylySalesModal'
  import JDate from '@/components/jeecg/JDate.vue'

  export default {
    name: 'ZnDaylySalesList',
    ...
    data () {
      return {
        ...
        url: {
          list: "/intel/znDaylySales/list",
          delete: "/intel/znDaylySales/delete",
          deleteBatch: "/intel/znDaylySales/deleteBatch",
          exportXlsUrl: "/intel/znDaylySales/exportXls",
          importExcelUrl: "intel/znDaylySales/importExcel",
