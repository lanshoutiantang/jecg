        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="单选" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="radio" v-decorator="['radio']" :trigger-change="true" dictCode="sex" placeholder="请选择单选"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="复选框" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-multi-select-tag type="checkbox" v-decorator="['checkbox']" :trigger-change="true" dictCode="sex" placeholder="请选择复选框"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="下拉多选" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-multi-select-tag type="list_multi" v-decorator="['selMul']" :trigger-change="true" dictCode="sex" placeholder="请选择下拉多选"/>
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/demo3/cesFiled_Kongjian/add",
          edit: "/demo3/cesFiled_Kongjian/edit",
          queryById: "/demo3/cesFiled_Kongjian/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','sex','radio','checkbox','selMul','selSearch','pic','files','remark','fuwenben','birthday','userSel','depSel'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','sex','radio','checkbox','selMul','selSearch','pic','files','remark','fuwenben','birthday','userSel','depSel'))
      },
    }
  }
</script>